...
ADIOS~\cite{lofstead:adaptible} API offers an API nearly as simple as POSIX, but with the
...
In this project we will extend ADIOS~\cite{lofstead:adaptible} with new APIs and novel
