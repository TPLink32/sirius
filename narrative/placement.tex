...
We address three main concerns for the data lifecycle in this work. First,
we will explore the initial placement of data during the output process.
Second, we will study techniques that can enhance migration without making
the eventual lookup of data unbounded. And finally, we will study how data
at each tier is managed. %FIXME

Towards this end, we will utilize the faster layer of the
storage hierarchies, such as DRAM, NVRAM and remote NVRAM, as the target for
