...
can be cast into multiple data buckets and each bucket can be given a different value
differently according to its utility.  Once this is done, the middleware
