...
placed one way in the 
the storage layers and later migrated to different layers as shown in Figure~\ref{fig:ssio-bucket} .
...
read in F with M, and want the same value of data from each piece.
