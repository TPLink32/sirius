...
relationship type.  In this project, a key set of metrics stored as a metadata
...
can be cast into multiple data buckets and each bucket can be given a different utility value.  
Based on this information, the middleware
...
length of time before the output data is visible to users and
...
respond to these new information.
