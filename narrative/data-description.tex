...
partition user level data into chunks, which are then executed by the middleware to
calculate the utility value for each chunk. This value, along with other
metadata, will be encapsulated by the middleware and utilized by the underlying
storage system to manage data placement.
%
