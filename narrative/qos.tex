...
that can help fulfill a particular request and the performance predictability of that request, and this demands
careful resource management strategies that deal with large number of data chunks spread across storage hierarchy. 
...
scalability, because there exists a single entity that tracks updates in the system. 
...
there is free space and there is very low bookkeeping overhead. However, unbounded search is possible, 
if it is unclear whether the resource actually exists. 
