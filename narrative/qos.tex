...
of allowing applications to compete, without restriction, for part or all of the storage
...
Unfettered, this competition will yield lower performance for all users than if applications
...
and reverting back to the previous committed resource level.
