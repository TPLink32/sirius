...
that can fulfill a particular request and the performance predictability of that request, and this demands
careful resource management strategies that can deal with placing and retrieving a large number of data 
chunks spread across the entire storage hierarchy. 
