...
\paragraph{Related Work:} On current production HPC systems, absolute IO performance
guarantees are not possible. Previous work \cite{lofstead:2010:io-variability,liu_hotstorage} 
from this project team uses a client-assisted approach to mitigate IO variablity at scale (100,000-core).
