...
3 & Mechanisms for data movement across the storage hierarchy & {\color{red}what are we doing. CHECK-tsr} & \S \ref{sec:managing-data-life},  \S\ref{sec:migration} \\\hline
