...
%2 & Mapping science data models onto hierarchical storage &  Create the ability to map, re-organize, reduce and prioritize data chunks from an object& \S\ref{sec:data-refactor}, \S\ref{sec:data-description},  \S\ref{sec:managing-data-life}\\\hline
...
subsets and pieces.
Key research challenges include: 1) developing an expressive and easy to use programinterface, 2) formulating a system model that can support 
