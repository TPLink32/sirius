...
\underline{Principle 1:} A knowledge-centric system that allows user expertise to define data policies. Today Storage System and I/O
...
exascale Systems. Unpredicitable performance in the I/O layer is often met with unpredictable guesses from users which decreases the effectiveness of simulation runs and the associated science.
