...
\underline{Principle 1:} {\bf A knowledge-centric system}, let user knowledge  to
...
\underline{Principle 2}: {\bf Predictable Performance in the SSIO layer} needs to be
