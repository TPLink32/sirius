...
{
fprintf(stderr, "im here %s %s %s %p %d %d %d %s:%d\n",group_name, name, mode, err, group_name_size, name_size, mode_size,__FILE__,__LINE__);
    char * buf1 = 0;
    char * buf2 = 0;
    char * buf3 = 0;
...
fprintf(stderr, "im here %s %s %s %p %s:%d\n",group_name, name, mode, err, __FILE__,__LINE__);
