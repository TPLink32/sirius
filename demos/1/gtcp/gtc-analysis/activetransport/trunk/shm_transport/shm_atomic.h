#ifndef _SHM_ATOMIC_H_
#define _SHM_ATOMIC_H_
/*
 * Atomic operations used by shm transport
 *
 * code borrowed from fastflow (mc-fastflow.sourceforge.net)
 * and lithe (http://parlab.eecs.berkeley.edu/lithe)
 */
