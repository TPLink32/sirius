...
{\bf Title of Pre-application:}  Science-driven Data Management for multi-tier storage\par
...
%for real-time-reduction and visualization.
  ...
  \includepdf[pages={1}]{COI/COI-all.pdf}
  \includepdf[pages={2}]{COI/COI-all.pdf}
\end{document}
