...
brings together a  team with strong expertise in I/O middleware (ORNL), file system (SNL, UCSC) and storage (UCSC), and connects and
...
application, but for the entire workload in a multi-user environment,
and allow for selectable data quality, by adjusting its accuracy and error, 
...
connecting differrent object quality and utility levels, 
