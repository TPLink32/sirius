...
\begin{comment}
  ...
  \textbf{Project title:}
  \vskip .1in
 Science-driven Data Management for multi-tier storage
...
Jay Lofstead, SNL & Kimmy Mu, ORNL \\
...
Our objective here is to reduce the time to insight, not just for a single
...
%the traditional high volume I/O pattern of
...
% This will facilitate efficient mapping of data from
% the user space onto multiple storage tiers, and enable application-guided
% data reductions/transformations to address capacity and bandwidth
% bottlenecks. 
%
...
will be a significant reduction in the time to insight, and the overall increase in 
...
%for real-time-reduction and visualization.
  ...
  \includepdf[pages=-]{COI/COI-all.pdf}
\end{document}
